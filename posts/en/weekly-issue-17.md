---
title: "Reflections on One Year as a VPS Enthusiast #17"
date: "2024-03-30"
...
A very warm song—listening to it when exhausted can be healing.

## Cover Image

![A quiet university lab with desks, computers, and a stuffed toy draped over a cubicle wall](https://cdn.sa.net/2024/03/30/UrtBANTC8VoDc9O.webp)

After my senior labmate finished his pre-defense, he moved out of the lab. Seeing others nearing graduation brings a mix of envy and an indescribable melancholy.
...
![A deliberately awkward portrait generated by Ugly Avatar](https://cdn.sa.net/2024/03/30/XuZhTLFHBf9MvdG.webp)
...
![Comic in which two people who matched online wait at adjacent numbered tables](https://cdn.sa.net/2024/03/30/PEjYscf4zhvgB6p.webp)


## Link Sharing

1. [Where to host my app?](https://web.archive.org/web/20250302023016/https://www.wheretohostmy.app/) *(archived copy)*

![Where to host my app interface comparing serverless hosting providers](https://cdn.sa.net/2024/03/30/8PWnERz51ehcFpf.webp)

Enter your tech stack and automatically get hosting provider recommendations. If you have a GPT subscription, you can use the [Where to host my app?](https://chat.openai.com/g/g-KmtFkh4VU-where-to-host-my-app) GPTs.

![Where to host my app assistant recommending providers in a chat](https://cdn.sa.net/2024/03/30/fDIhMvunq1EA8Js.webp)

2. [Starlink map](https://www.starlinkmap.org/)

![Interactive globe covered with red markers for thousands of Starlink satellites](https://cdn.sa.net/2024/03/30/xFgS3ubr6EDmXpv.webp)
